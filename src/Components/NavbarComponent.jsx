        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden space-x-6 md:flex">
            ...
            {userState && userState.loginStatus && (
              <>
                <a href="/donate" className="hover:text-darkGrayishBlue">
                  DONATE
                </a>
                <a href="/burrow" className="hover:text-darkGrayishBlue">
                  BORROW
                </a>
              </>
            )}
            <a href="/contact-us" className="hover:text-darkGrayishBlue">
              CONTACT US
            </a>
            <a href="/digital-library" className="hover:text-darkGrayishBlue">
              DIGITAL LIBRARY
            </a>
          </div>
          ...
          {userState && userState.loginStatus && (
            <div className="md:flex space-x-2">
              <p className="hidden md:block mt-3">{userState.user.email}</p>
