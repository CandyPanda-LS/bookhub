                                        ...
                                        <div className="bg-white px-4 py-5 sm:p-6">
                                            <div className="grid grid-cols-6 gap-6">
                                                <div className="col-span-6 sm:col-span-3">
                                                    <label for="first-name" className="block text-sm font-medium text-left text-gray-700">Book Title</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3">
                                                    <label for="last-name" className="block text-sm font-medium text-left text-gray-700">Author name</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3">
                                                    <label for="country" className="block text-sm font-medium text-left text-gray-700">Genre</label>
                                                ...
                                                <div className="col-span-6">
                                                    <label for="street-address" className="block text-sm text-left font-medium text-gray-700">Discription</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                                                    <label for="city" className="block text-sm font-medium text-left text-gray-700">Publisher</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label for="region" className="block text-sm font-medium text-left text-gray-700">Edition</label>
