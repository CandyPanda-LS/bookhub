...
function ContactUsPageComponent() {
    return (
        <div className='m-5'>
            <section ection id='contact' class="relative z-10 overflow-hidden bg-slate-100 px-10 py-10 rounded-xl">
                            ...
                            <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                                <form>
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            class="bg-brightRed border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                        >
                                            Send Message
                                        </button>
                                    </div>
