        ...
        <div className="m-5">
          <div className='flex'>
            <div className="flex flex-col hidden md:block  space-y-12 md:w-1/2 ">
              <h1
                className="max-w-md text-xl font-bold text-center md:text-5xl md:text-left"
              >
            ...
            <div className="container flex bg-bannerBlue rounded-xl	 flex-col-reverse  px-10 py-10 mx-auto space-y-0 md:space-y-0 md:flex-row">
              <div className='my-5 md:mx-10 md:w-1/2'>
                ...
                <label className="block text-sm font-medium text-left text-gray-100 mt-5">Email / Username</label>
                <div className="mt-1 flex rounded-md shadow-sm">
                  <span className="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-xl text-gray-500"><CgProfile/></span>
                  <input type="text" name="company-website" id="company-website" className="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-brightRed focus:ring-brightRed sm:text-sm" placeholder="username/email...." />
                </div>
                <label className="block text-sm font-medium text-left text-gray-100 mt-5">Password</label>
                <div className="mt-1 flex rounded-md shadow-sm">
                  <span className="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-xl text-gray-500"><AiFillLock/></span>
                  <input type="text" name="company-website" id="company-website" className="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-brightRed focus:ring-brightRed sm:text-sm" placeholder="password...." />
                </div>
