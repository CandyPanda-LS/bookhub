                          ...
                          <div className="flex">
                            ...
                            <div className="ml-3 text-sm text-left">
                              ...
                              <p className="text-gray-500">
                                I am a student of a recognized institute in
                                Srilanka. Thus I am eligible for the rewards
                                that are associated.(uncheck the box if you are
                                not)
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex">
                            <div className="flex h-5 items-center ">
                              <input
                                ...
                                className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                onChange={(e) =>
                                  setisPrivacyEnable(e.target.value)
                                }
                              />
                            </div>
                            <div className="ml-3 text-sm text-left">
                              <label
                                ...
                                className="font-medium text-gray-700"
                              >
                                Are you willing to share your information with
                                the other users ?
                              </label>
                              <p className="text-gray-500">
                                I am willing to give concent to share
                                information publicly (Uncheck the box if you are
                                not willing)
                              </p>
                            </div>
                          </div>
