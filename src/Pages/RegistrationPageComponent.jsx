                ...
                <div className="container shadow rounded-xl border-2 borer-grey">
                                    ...
                                    <div className="overflow-hidden shadow sm:rounded-md">
                                        <div className="bg-white px-4 py-5 sm:p-6">
                                            <div className="grid grid-cols-6 gap-6">
                                                ...
                                                <div className="col-span-6 sm:col-span-3">
                                                    <label htmlFor="last-name" className="block text-sm font-medium text-gray-700">username</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3">
                                                    <label htmlFor="last-name" className="block text-sm font-medium text-gray-700">Contact Number</label>
                                                    <input type="text" name="last-name" id="last-name" autoComplete="family-name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                                                </div>
                                                ...
                                                <div className="col-span-6">
                                                    <label htmlFor="street-address" className="block text-sm font-medium text-gray-700">Address</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label htmlFor="postal-code" className="block text-sm font-medium text-gray-700">Company or University</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                                                    <label htmlFor="city" className="block text-sm font-medium text-gray-700">Password</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label htmlFor="region" className="block text-sm font-medium text-gray-700">Confirm Password</label>
                                                ...
                                                <div className="col-span-6 sm:col-span-3 space-x-5">
                                                    <div className='flex'>
                                                        ...
                                                        <div className="ml-3 text-sm text-left">
                                                            <label htmlFor="comments" className="font-medium text-gray-700">Are you a student?</label>
                                                            <p className="text-gray-500">I am a student of a recognized institute in Srilanka. Thus I am eligible for the rewards that are associated.(uncheck the box if you are not)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-span-6 sm:col-span-3 space-x-5">
                                                    <div className='flex'>
                                                        ...
                                                        <div className="ml-3 text-sm text-left">
                                                            <label htmlFor="comments" className="font-medium text-gray-700">Are you willing to share your information with the other users ?</label>
                                                            <p className="text-gray-500">I am willing to give concent to share information publicly (Uncheck the box if you are not willing)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div>
                        <div className="md:grid md:grid-cols-3 md:gap-6">
                            <div className="md:col-span-1">
                                <div className="px-4 sm:px-0">
                                    <h3 className="text-lg font-medium leading-6 text-gray-900 mt-5">Profile Picture</h3>
